...
@csrf
  <div class="form-row">
    ...
    <div class="form-group col-md-12">
      ...
      <input type="email" name="email" value="{{old('email')}}" class="form-control" id="inputEmail4" placeholder="Customer Email">
    </div>
</div>
  ...
  <div class="form-row">
      ...
      <input type="text" name="name" class="form-control" value="{{old('name')}}" id="inputEmail4" placeholder="Customer Name" required>
    </div>
