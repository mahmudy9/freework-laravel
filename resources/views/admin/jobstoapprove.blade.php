        ...
        @foreach($jobs as $job)
            <div class="card mb-3" id="{{$job->id}}" >
                ...
                <div class="card-body">
                    ...
                    <div class="col-4">
                        <button class="btn btn-success" onclick="approvejob('{{url('/admin/approvejob')}}', '{{$job->id}}')" >Approve Job</button>
                    </div>
                    <div class="col-4">
                        <button class="btn btn-danger" onclick="disapprovejob('{{url('/admin/disapprovejob')}}' , '{{$job->id}}')" >Disapprove Job</button>
                    </div>
                    </div>
                </div>
            </div>
